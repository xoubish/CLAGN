...
Regenerate with `python check_a3_spherex_variability.py --target P1823 --include-excluded`.
...
- independent_errors: chi-square = 24.05, dof = 14, p = 0.0452.
- epoch_correlated_calibration: chi-square = 19.68, dof = 14, p = 0.1405.
- excess_scatter_and_correlated_calibration: chi-square = 11.21, dof = 14, p = 0.6691.
