...
| `40_september_observing_packet.py` | Build the September sequence packet: NGPS CSVs, backups, timing, README and run information (pages retired 2026-09-21; run `16` then `51` afterwards). |
