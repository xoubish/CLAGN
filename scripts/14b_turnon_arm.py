...
HERE = os.path.dirname(os.path.dirname(os.path.abspath(__file__))); DATA = os.path.join(HERE, 'data'); PY = sys.executable
...
def main():
    ...
    subprocess.run([PY, os.path.join(HERE, 'scripts', '05_observability.py'), pos, obs], check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
