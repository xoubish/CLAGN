...
spec = importlib.util.spec_from_file_location('f03d', os.path.join(HERE, '03d_fetch_spectra.py')); f03d = importlib.util.module_from_spec(spec); spec.loader.exec_module(f03d)
